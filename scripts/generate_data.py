...
if __name__ == "__main__":
    # 1. 임계값 로드
    thresholds = load_calibration_config('../data/calibration_thresholds.json')
    ...
    if all(thresholds): # T1, T2, T3가 모두 None이 아니면
        ...
        generate_data_from_video(VIDEO_FILE_PATH, thresholds, output_file='../data/training_data.json')
